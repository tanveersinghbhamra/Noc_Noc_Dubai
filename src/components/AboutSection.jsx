      ...
      <h2
        ...
        <div
          ...
          <div
            ...
            <span className=""> The night starts here.</span>
          </div>
          <div
            className="relative bg-clip-text text-transparent bg-no-repeat bg-gradient-to-r from-yellow-500 via-violet-500 to-orange-500 py-4">
            <span className=""> The night starts here.</span>
          </div>
        </div>
      </h2>
