...
export function BackgroundBoxes() {
  return (
    <div
      className="h-2/3 relative  pt-40 pb-30 w-full overflow-hidden bg-black flex flex-col items-center justify-center rounded-lg">
      <div
      ...
      <p className="text-white text-lg sm:text-2xl md:text-2xl lg:text-3xl font-semibold leading-relaxed text-center max-w-5xl">
